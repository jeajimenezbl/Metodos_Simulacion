...
{
    private:
        vector3D r,V,F,Omega;
        double m,R;
    public:
        void Inicie(double x0,double y0,double z0,double Vx0,double Vy0,double Vz0,double m0,double R0,double Omega0);
...
void Cuerpo::Inicie(double x0,double y0,double z0,double Vx0,double Vy0,double Vz0,double m0,double R0,double Omega0){
  r.cargue(x0,y0,z0); V.cargue(Vx0,Vy0,Vz0);  m=m0;  R=R0; Omega.cargue(0,0,Omega0); 
} 
...
int main(void){
  ...
  double x0,y0,z0,Vx0,Vy0,Vz0,Omega0;
  x0=0;
  y0=0;
  z0=0;
  Vx0=V0*cos(gamma);
  ...
  Balon.Inicie(x0, y0,z0,Vx0,Vy0,Vz0, m,R, Omega0);
